...
## Project Structure
    ...
    ├── figmapermissionapp_5  # Django project configurations
...
1. Clone this repo and `cd figmapermissionapp_5`
...
2. Clone this repo and `cd figmapermissionapp_5`
